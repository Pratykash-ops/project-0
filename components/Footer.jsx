...
export default function Footer () {
    return <footer className="footer footer-center p-10 mt-5 ">
    <aside>
      ...
      <p className="font-bold">
        Project 0. <br/>A Platform dedicated to students
      </p> 
      <p>Copyright © {new Date().getFullYear()} - All right reserved</p>
    </aside> 
    <nav>
      <div className="grid grid-flow-col gap-4">
        <Link href={"https://discord.gg/Gj38EEE9"}><FaDiscord size={24}/></Link>
